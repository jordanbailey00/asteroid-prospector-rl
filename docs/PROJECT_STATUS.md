...
- `gh workflow run m9-deployment-smoke.yml ... require_clean_wandb_status=true` -> success (run `22655777348`) after CORS guardrail patch, artifact: `artifacts/deploy/ci-m9-smoke-22655777348/m9-deployment-smoke-22655777348/m9-smoke-22655777348.json` (15/15 checks).
