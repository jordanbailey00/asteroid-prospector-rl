...
Invoke-Step -Label "Black (check)" -Command { python -m black --check python training replay server ops_console tests tools }
Invoke-Step -Label "Ruff (lint)" -Command { python -m ruff check python training replay server ops_console tests tools }
