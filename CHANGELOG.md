...
- Added throughput profiler native reset compatibility (`NativeProspectorCore.reset(...)` obs-only return shape) plus regression coverage in `tests/test_profile_training_throughput.py`.
